...
def api_door_snapshot(door_id):
    ...
    # Late import: qr_live pulls in cv2 + ultralytics at top, fine
    # since the detector is running in this same process.
    import qr_live
    import cv2

    live = qr_live.get_live_door(door_row['name'])
    if live is None or live.camera is None:
